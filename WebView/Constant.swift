...
public struct Constants {
    ...
    // OneSignal Options
    static let kPushEnabled         = false; //set to true to activate OneSignal Push (set App ID in AppDelegate.swift)
    static let kPushEnhanceUrl      = false; //set to true if you want to extend URL request by ?onesignal_push_id=XYZ
    static let kPushReloadOnUserId  = false; //set to true if WebView should be reloaded when the app gets a UserID from OneSignal
